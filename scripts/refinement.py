    ...
    def refine_plan(self, action_list):
        ...
        for high_level_action in action_list:
            ...
            if(high_level_action[0] == "move"):
            	goal_loc=self.get_load_locations(high_level_action[3])
            	path_obj=self.get_path(current_state,goal_loc)
            	current_state=path_obj[1]
            	actions.append(("move",path_obj[0],path_obj[1].get_gazebo_repr()))
...
def generate_plan(env,planner_name):
    ...
    action_list = planner.run_planner(planner_name, domain_file_path,
...
if __name__ == "__main__":
    ...
    if os.path.exists(FILE_PATH):
        ...
        file_handle.write("Object_types; object_count; seed; exception; refined_plan; env\n")
